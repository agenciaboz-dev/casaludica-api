export const newsletterWelcomeString = (name: string) =>
    `
    Olá ${name}, estamos super empolgados por ter você conosco!
    🌟 Bem-vindo(a) à nossa comunidade de entusiastas por um lar mais feliz e cheio de personalidade.
    Ao se inscrever em nossa newsletter, você deu um passo incrível para transformar seu espaço com estilo, conforto e muita diversão.
    Aqui na Casa Lúdica, acreditamos que cada detalhe faz a diferença e estamos aqui para te ajudar a encontrar exatamente o que seu coração deseja.
    O que você pode esperar?
    🚀 Lançamentos Exclusivos: Seja o primeiro a saber sobre nossas novidades e coleções limitadas.
    💡 Inspirações: Dicas práticas e ideias criativas para você inovar na decoração.
    💥 Promoções Especiais: Acesso a descontos e ofertas exclusivas apenas para nossos assinantes.
    📚 Guias e Tutoriais: Conteúdos ricos para te ajudar a maximizar o potencial de cada compra.
    Sua Opinião Importa!
    Estamos sempre buscando melhorar e oferecer o que há de melhor para você.
    Não hesite em nos contar o que gostaria de ver em nossas newsletters ou como podemos tornar sua experiência ainda mais incrível.
    Agradecemos por se juntar a nós. Prepare-se para descobertas incríveis!
    Atenciosamente,
    Equipe Casa Lúdica
    `

export const newsletterWelcome = (name: string) =>
    `
<!doctype html>
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                        <div style="font-family:Poppins;font-size:15px;line-height:30px;text-align:left;color:#282828;">Olá ${name},</div>
                      </td>
                    </tr>
                    <tr>
                      <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                        <div style="font-family:Poppins;font-size:15px;line-height:30px;text-align:left;color:#282828;">Estamos super empolgados por ter você conosco! 🌟 Bem-vindo(a) à nossa comunidade de entusiastas por um lar mais feliz e cheio de personalidade.</div>
                      </td>
                    </tr>
                    <tr>
                      <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                        <div style="font-family:Poppins;font-size:15px;line-height:30px;text-align:left;color:#282828;">Ao se inscrever em nossa newsletter, você deu um passo incrível para transformar seu espaço com estilo, conforto e muita diversão. Aqui na Casa Lúdica, acreditamos que cada detalhe faz a diferença e estamos aqui para te ajudar a encontrar exatamente o que seu coração deseja.</div>
                      </td>
                    </tr>
                    <tr>
                      <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                        <div style="font-family:Poppins;font-size:15px;line-height:30px;text-align:left;color:#282828;">
                          ...
                          <ul>
                            <li>🚀 Lançamentos Exclusivos: Seja o primeiro a saber sobre nossas novidades e coleções limitadas.</li>
                            <li>💡 Inspirações: Dicas práticas e ideias criativas para você inovar na decoração.</li>
                            <li>💥 Promoções Especiais: Acesso a descontos e ofertas exclusivas apenas para nossos assinantes.</li>
                            <li>📚 Guias e Tutoriais: Conteúdos ricos para te ajudar a maximizar o potencial de cada compra.</li>
                          </ul>
                        </div>
                      </td>
                    </tr>
                    ...
                    <tr>
                      <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                        <div style="font-family:Poppins;font-size:15px;line-height:30px;text-align:left;color:#282828;">Estamos sempre buscando melhorar e oferecer o que há de melhor para você. Não hesite em nos contar o que gostaria de ver em nossas newsletters ou como podemos tornar sua experiência ainda mais incrível.</div>
                      </td>
                    </tr>
                    <tr>
                      <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                        <div style="font-family:Poppins;font-size:15px;line-height:30px;text-align:left;color:#282828;">Agradecemos por se juntar a nós. Prepare-se para descobertas incríveis!</div>
                      </td>
                    </tr>
                    <tr>
                      <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
