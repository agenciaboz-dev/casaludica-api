...
export const pedidoFaturadoClienteString = (user: User, order: Order) =>
    ...
    Endereço de entrega:
        ...
        Agora, estamos trabalhando para preparar e enviar sua compra o mais rápido possível.
        Se tiver qualquer dúvida ou precisar de assistência, não hesite em nos contatar. Estamos aqui para ajudar!
        Agradecemos por escolher a Casa Lúdica para suas aventuras.
...
export const pedidoFaturadoCliente = (user: User, order: Order) =>
    `
...
<title>Seu Pedido foi Faturado - Nota Fiscal Anexa</title>
<style type="text/css">
	/* FONTS  */
			...
			<tr>
				<td style="padding: 20px 35px 0px;">
					<table width="100%">
						...
						<tr>
							<td>
								<h3>Seu Pedido foi Faturado - Nota Fiscal Anexa!</h3>
								<p style="text-align: left;">
									Olá ${user.name},
								</p>
								<p>
									Temos boas notícias! Seu pedido número <b>${order.id}</b> foi faturado e estamos um passo mais perto de enviar sua compra até você.
								</p>
								<p>
									Anexamos a nota fiscal deste pedido para sua conveniência e registro. É importante guardar este documento, pois ele contém informações valiosas sobre sua compra.
								</p>
							</td>
						</tr>				
