...
<title>Pedido Nº ${order.id} Concluído com Sucesso</title>
<style type="text/css">
	/* FONTS  */
					...
					<table width="100%">
						...
						<tr>
							<td>
								...
								<p>
									Temos ótimas notícias! O pedido número ${order.id}, feito por ${user.name}, foi concluído e enviado com sucesso. Este é mais um marco em nossa jornada, demonstrando o compromisso e a eficiência da nossa equipe em proporcionar as melhores experiências aos nossos clientes.
								</p>
								<h4>Detalhes do Pedido Concluído:</h4>
								<p style="text-align: left;">
									${user.name}<br>
									${order.datetime}
								</p>
								...
								<p>
									Aproveitem este momento para celebrar mais uma vitória! E que venham muitas outras. Continuemos trabalhando juntos para fazer da Casa Lúdica o destino favorito dos nossos clientes.
