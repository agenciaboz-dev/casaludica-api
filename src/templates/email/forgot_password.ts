...
export const forgot_password_string = (user: User, url: string) =>
    `
    Olá ${user.name},
...
export const forgot_password = (user: User, url: string) => `
<!doctype html>
                          ...
                          <tbody>
                            <tr>
                              <td align="center" bgcolor="#363775" role="presentation" style="border:none;border-radius:15px;cursor:auto;mso-padding-alt:10px 25px;background:#363775;" valign="middle">
                                <a href="${url}" style="display:inline-block;background:#363775;color:#ffffff;font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;font-weight:normal;line-height:25px;margin:0;text-decoration:none;text-transform:none;padding:10px 25px;mso-padding-alt:0px;border-radius:15px;" target="_blank"> Redefinir Minha Senha </a>
                              </td>
                            </tr>
                          </tbody>
                        </table>
