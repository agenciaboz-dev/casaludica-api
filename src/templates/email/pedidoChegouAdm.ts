...
Bairro: ${user.district}<br>
Cidade: ${user.city}<br>
CEP: ${user.postcode}<br>
E-mail: ${user.email}<br>
Telefone: ${user.phone}

Gostaríamos de destacar que o cliente já foi notificado da entrega com sucesso do seu pedido. Encorajamos a manutenção do alto padrão de serviço e produtos que a Casa Lúdica oferece.

Caso haja qualquer feedback do cliente ou necessidade de acompanhamento, entraremos em contato para as devidas providências. Agradecemos a sua atenção e dedicação contínuas para garantir a satisfação dos nossos clientes.

Por favor, sinta-se à vontade para entrar em contato caso tenha alguma dúvida ou necessite de mais informações.
...
export const pedidoChegouAdm = (user: User, order: Order) =>
    `<!doctype html>
...
.moz-text-html .mj-column-px-300 { width:300px !important; max-width: 300px; }
  ...
  <body style="word-spacing:normal;background-color:#363775;">
     ...
     <!--[if mso | IE]><table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" ><tr><td><![endif]-->
      ...
      ><h1>Confirmação de Entrega do Pedido - #${order.id}</h1></div>
      ...
      <div
         style="font-family:Poppins;font-size:15px;line-height:30px;text-align:left;color:#282828;"
      >Gostaríamos de destacar que o cliente já foi notificado da entrega com sucesso do seu pedido. Encorajamos a manutenção do alto padrão de serviço e produtos que a Casa Lúdica oferece.</div>
      ...
      <div
         style="font-family:Poppins;font-size:15px;line-height:30px;text-align:left;color:#282828;"
      >Caso haja qualquer feedback do cliente ou necessidade de acompanhamento, entraremos em contato para as devidas providências. Agradecemos a sua atenção e dedicação contínuas para garantir a satisfação dos nossos clientes.</div>
      ...
      <div
         style="font-family:Poppins;font-size:15px;line-height:30px;text-align:left;color:#282828;"
      >Por favor, sinta-se à vontade para entrar em contato caso tenha alguma dúvida ou necessite de mais informações.</div>
      ...
      <div
         style="font-family:Poppins;font-size:15px;line-height:30px;text-align:left;color:#282828;"
      ><br>Atenciosamente,</br> Equipe Casa Lúdica</div>
