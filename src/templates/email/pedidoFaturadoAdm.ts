...
<title>Pedido Nº ${order.id} Faturado - Nota Fiscal Emitida</title>
<style type="text/css">
	/* FONTS  */
			...
			<tr>
				<td style="padding: 20px 35px 0px;">
					<table width="100%">
						...
						<tr>
							<td>
								<h3>Pedido Nº ${order.id} Faturado - Nota Fiscal Emitida</h3>
								<p style="text-align: left;">
									Olá equipe Casa Lúdica,
								</p>
								<p>
									Mais uma etapa concluída com sucesso! O pedido número ${order.id}, realizado por ${
        user.name
    }, foi devidamente faturado, e a nota fiscal correspondente já foi emitida e anexada.
						...
						<tr>
							<td>
								...
								<p>
									Este é um passo crucial no nosso processo de entrega, garantindo transparência e conformidade. Agora, o próximo passo é preparar o pedido para envio, assegurando que tudo esteja perfeito para nossa entrega.
								</p>
								<p>
									Agradecemos a dedicação de todos para manter a excelência no nosso serviço. Continuemos trabalhando juntos para oferecer as melhores experiências aos nossos clientes.
								</p>
								<p>
									Atenciosamente,<br>
