...
export const processandoPedidoAdmString = (user: User, order: Order) =>
    ...
    Endereço de entrega:
        ...
        Agradecemos por toda a dedicação e esforço colocados em cada pedido.
...
export const processandoPedidoAdm = (user: User, order: Order) =>
    `
...
<title>Confirmado Pagamento - Pedido Nº ${order.id}</title>
<style type="text/css">
	/* FONTS  */
			...
			<tr>
				<td style="padding: 20px 35px 0px;">
					<table width="100%">
						...
						<tr>
							<td>
								<h3>Pedido Nº ${order.id} em Processamento!</h3>
								<p style="text-align: left;">
									Olá equipe Casa Lúdica,
								</p>
								<p>
									Preparar, apontar... e vamos nessa! O pedido número <b>${
                                        order.id
                                    }</b> acaba de entrar na fase de processamento. Isso significa que tudo está correndo conforme o planejado e estamos um passo mais perto de completar mais uma entrega mágica.
								</p>
								<p>Por favor, continuem com o excelente trabalho, assegurando que todos os detalhes estejam perfeitos para enviar ao nosso cliente uma experiência inesquecível.</p>
							</td>
						</tr>				
